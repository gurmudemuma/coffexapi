            ...
            <div className="p-8">
              ...
              <div className="mt-8 p-5 bg-amber-50 rounded-lg border border-amber-200">
                ...
                <div className="grid grid-cols-2 gap-2 mt-4">
                  <Button variant="outline" size="sm" onClick={() => handleDemoLogin('exporter')}>Exporter</Button>
                  <Button variant="outline" size="sm" onClick={() => handleDemoLogin('nbe')}>National Bank</Button>
                  <Button variant="outline" size="sm" onClick={() => handleDemoLogin('quality')}>Quality Authority</Button>
                  <Button variant="outline" size="sm" onClick={() => handleDemoLogin('customs')}>Customs</Button>
                  <Button variant="outline" size="sm" onClick={() => handleDemoLogin('bank')}>Exporter Bank</Button>
